sap.ui.define([
    ...
    return BaseController.extend("testapp.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                BILLING_PRICE__C: function(oContext) {
                    var iNumber = oContext.getProperty('BILLING_PRICE__C'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("PRODUCT_UNIQUE_KEY__C", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "testapp.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("BILLING_PRICE__C", FilterOperator.LE, 100));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("BILLING_PRICE__C", FilterOperator.GT, 100));
                        break;
                    default :
                        break;
                }
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("PRODUCT_UNIQUE_KEY__C")
            }, bReplace);
        },
